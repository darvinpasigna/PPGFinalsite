        ...
        <footer>
            ...
            <hr style={{ height: '4px', backgroundColor: 'black' }} />
                ...
                <div className='col-3'>
                  ...
                  {footerCard.slice(600, 603).map((card) =>(
                                <div className="col-md-4">
                                  <img src={card.card_images[0].image_url} className="img-fluid rounded-start" alt="cardpic" style={{width: "80%"}} />
                              </div>
                   ))}
                    </div>
                  </div>
                <div className='col-3'>
                    <h4 style={{textAlign: "center"}}>HIGH LEVEL</h4>
                    <div className='d-flex-wrap'>
                    {footerCard.slice(2000, 2003).map((card) =>(
                                <div className="col-md-4">
                                  <img src={card.card_images[0].image_url} className="img-fluid rounded-start" alt="cardpic" style={{width: "80%"}} />
                              </div>
                   ))}
                ...
                <div className='col-3'>
                    ...
                    <YouTube videoId="YWVwI_F4Bn0" opts={videoOpts} />
                    </div>
                </div>
            </div>
        </footer>
